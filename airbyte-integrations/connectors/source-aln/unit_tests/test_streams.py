...
import pytest
from source_aln.source import AlnStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AlnStream, "path", "v0/example_endpoint")
    mocker.patch.object(AlnStream, "primary_key", "test_primary_key")
    mocker.patch.object(AlnStream, "__abstractmethods__", set())
